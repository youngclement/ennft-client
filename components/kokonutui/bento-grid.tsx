                        ...
                        <div className="flex flex-col mt-2">
                            <div className="flex flex-wrap gap-2 mb-2">
                                {item.tags?.map((tag, i) => (
                                    <span
                                        key={i}
                                        className="px-2 py-1 rounded-md bg-black/5 dark:bg-white/10 backdrop-blur-xs text-xs text-gray-500 dark:text-gray-400 transition-all duration-200 hover:bg-black/10 dark:hover:bg-white/20"
                                    >
                                        #{tag}
                                    </span>
                                ))}
